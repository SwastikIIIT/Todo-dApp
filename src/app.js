App = {
  ...
  loadAccount: async () => {
    ...
    App.account = App.accounts[2]; // 0xDDcbDcf62397c76367fFA6A639338Eeec68eAf0D
  ...
  createTasks: async () => {
    try {
      ...
      console.log("Task successfully created on the blockchain!");
      window.location.reload();
    } catch (err) {
      console.log("Erro in creation:", err);
    } 
  },
